...
export const serviceCategories: ServiceCategory[] = [
  ...
  { id: "legal", name: "আইনি সেবা ও ডকুমেন্ট", nameEn: "Legal & Documents", icon: catLegal, serviceSlugs: ["legal-consultation", "document-drafting", "passport-nid", "birth-certificate", "tax-return", "trade-license", "insurance-service"], color: colors.slate },
