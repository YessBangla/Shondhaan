...
export const allServices: ServiceData[] = [
  ...
  { slug: "livestock-care", title: "প্রাণিসার্ভিস", titleEn: "Livestock Care", description: "গবাদি পশু ও পোল্ট্রির চিকিৎসা, টিকাদান ও পরামর্শ সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 180, totalOrders: 900, packages: [
  ...
  { slug: "septic-tank", title: "সেপটিক ট্যাংক ক্লিনিং", titleEn: "Septic Tank Cleaning", description: "সেপটিক ট্যাংক ও ড্রেইন পরিষ্কার সার্ভিস। ভ্যাকুয়াম ট্রাক দ্বারা দ্রুত ও স্বাস্থ্যসম্মত সার্ভিস।", image: "/placeholder.svg", rating: 4.4, totalReviews: 320, totalOrders: 2100, packages: [
  ...
  { slug: "passport-nid", title: "পাসপোর্ট ও NID সার্ভিস", titleEn: "Passport & NID Service", description: "পাসপোর্ট নবায়ন, NID সংশোধন, জন্ম নিবন্ধন ও সরকারি কাগজপত্র প্রক্রিয়াকরণ সহায়তা।", image: "/placeholder.svg", rating: 4.7, totalReviews: 1800, totalOrders: 12000, packages: [
  ...
  { slug: "property-buy-sell", title: "জমি ও প্রপার্টি ক্রয়-বিক্রয়", titleEn: "Property Buy & Sell", description: "জমি, ফ্ল্যাট, বাড়ি ও কমার্শিয়াল প্রপার্টি ক্রয়-বিক্রয় সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 1200, totalOrders: 5500, packages: [
  ...
  { slug: "tax-return", title: "ট্যাক্স রিটার্ন ফাইলিং", titleEn: "Tax Return Filing", description: "আয়কর রিটার্ন দাখিল, TIN সার্টিফিকেট ও ট্যাক্স কনসালটেশন সার্ভিস।", image: "/placeholder.svg", rating: 4.7, totalReviews: 680, totalOrders: 3500, packages: [
  ...
  { slug: "trade-license", title: "ট্রেড লাইসেন্স ও কোম্পানি রেজি.", titleEn: "Trade License & Registration", description: "ট্রেড লাইসেন্স, কোম্পানি রেজিস্ট্রেশন, RJSC ফাইলিং ও ব্যবসায়িক লাইসেন্স সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 420, totalOrders: 2200, packages: [
  ...
  // --- Insurance ---
  { slug: "insurance-service", title: "ইন্স্যুরেন্স সার্ভিস", titleEn: "Insurance Service", description: "লাইফ, হেলথ, ভেহিকেল ও প্রপার্টি ইন্স্যুরেন্স পরিকল্পনা ও ক্লেইম সাপোর্ট।", image: "/placeholder.svg", rating: 4.5, totalReviews: 380, totalOrders: 1800, packages: [
  ...
  { slug: "marriage-media", title: "ম্যারেজ মিডিয়া", titleEn: "Marriage Media", description: "বিশ্বস্ত ম্যাচমেকিং সার্ভিস। বায়োডাটা ভেরিফিকেশন, পাত্র-পাত্রী খোঁজা ও পরিবার পরিচয়।", image: "/placeholder.svg", rating: 4.6, totalReviews: 2800, totalOrders: 15000, packages: [
  ...
  // --- Funeral & Religious ---
  { slug: "janaza-service", title: "জানাজা ও দাফন সার্ভিস", titleEn: "Janaza & Burial Service", description: "জানাজার আয়োজন, গোসল, কাফন, কবর খনন ও দাফন সংক্রান্ত সকল সার্ভিস।", image: "/placeholder.svg", rating: 4.9, totalReviews: 350, totalOrders: 2200, packages: [
  ...
  // --- Hajj & Umrah ---
  { slug: "hajj-umrah", title: "হজ্জ ও ওমরাহ সার্ভিস", titleEn: "Hajj & Umrah Services", description: "সম্পূর্ণ হজ্জ ও ওমরাহ প্যাকেজ — ভিসা, ফ্লাইট, হোটেল ও গাইড সহ।", image: "/placeholder.svg", rating: 4.8, totalReviews: 1200, totalOrders: 8000, packages: [
