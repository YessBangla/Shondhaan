...
export const allServices: ServiceData[] = [
  ...
  },
  {
    ...
    features: ["লাইসেন্সড ইলেকট্রিশিয়ান", "সেফটি স্ট্যান্ডার্ড", "ওয়ারেন্টি সার্ভিস", "জরুরি সেবা"],
  ...
  },
  {
    ...
    titleEn: "Salon Care",
    image: serviceSalon,
    description: "ঘরে বসে পেশাদার সেলুন সেবা। হেয়ারকাট, ফেসিয়াল, মেকআপ, ব্রাইডাল প্যাকেজ সব পাবেন।",
    rating: 4.9,
    totalReviews: 5600,
    totalOrders: 20000,
    packages: [
  ...
  },
  {
    ...
    description: "ঝামেলামুক্ত হাউজ শিফটিং সেবা। প্যাকিং, লোডিং, ট্রান্সপোর্ট, আনলোডিং — সব একসাথে।",
    rating: 4.4,
    totalReviews: 980,
    totalOrders: 3500,
    packages: [
  ...
  },
  {
    ...
    image: serviceGas,
    description: "গ্যাস স্টোভ রিপেয়ার, সার্ভিসিং ও ইনস্টলেশন। সকল ব্র্যান্ডের গ্যাস স্টোভের সেবা পাবেন।",
    rating: 4.5,
    totalReviews: 870,
    totalOrders: 3000,
    packages: [
  ...
  },
  {
    ...
    image: serviceSpa,
    description: "ঘরে বসে রিল্যাক্সিং স্পা সেবা। বডি ম্যাসাজ, আরোমাথেরাপি, স্ট্রেস রিলিফ — সব পেশাদার থেরাপিস্টের মাধ্যমে।",
    rating: 4.8,
    totalReviews: 2100,
    totalOrders: 7500,
    packages: [
  ...
  },
  {
    ...
    description: "বাড়িতে বসে প্রফেশনাল নার্সিং সেবা। রোগী পরিচর্যা, বয়স্ক যত্ন, ফিজিওথেরাপি — সব একখানে।",
    rating: 4.8,
    totalReviews: 1890,
    totalOrders: 6800,
    packages: [
      { name: "ডে কেয়ার", price: 999, features: ["৮ ঘণ্টা সেবা", "রোগী পরিচর্যা", "ওষুধ ব্যবস্থাপনা"] },
      { name: "নাইট কেয়ার", price: 1299, originalPrice: 1499, features: ["১২ ঘণ্টা রাতের সেবা", "রোগী মনিটরিং", "ইমার্জেন্সি সাপোর্ট"] },
      { name: "ফুলটাইম কেয়ারগিভার", price: 18000, originalPrice: 22000, features: ["মাসিক সেবা", "২৪/৭ কেয়ার", "মেডিকেল রিপোর্টিং", "ফিজিওথেরাপি সাপোর্ট"] },
    ],
    reviews: [
  ...
  },
  {
    ...
    reviews: [
      ...
      { name: "আব্দুল করিম", rating: 5, date: "১০ মার্চ ২০২৬", comment: "বয়স্ক বাবা-মায়ের জন্য মাসিক প্যাকেজ নিয়েছি। দারুণ সেবা!" },
  ...
  },
  {
    ...
    image: "/placeholder.svg",
    description: "ঘরে বসে প্রফেশনাল ফিজিওথেরাপি সেবা নিন। ব্যাক পেইন, জয়েন্ট পেইন, স্পোর্টস ইনজুরি, স্ট্রোক রিহ্যাবিলিটেশন — সব ধরনের ফিজিওথেরাপি সেবা পাবেন।",
    rating: 4.7,
    totalReviews: 1450,
    totalOrders: 5100,
    packages: [
  ...
  },
  {
    ...
    image: "/placeholder.svg",
    description: "আধুনিক ডায়াগনস্টিক সেবা — এক্স-রে, আল্ট্রাসনোগ্রাম, ইসিজি, ইকো, সিটি স্ক্যান, এমআরআই বুকিং ও রিপোর্ট ডেলিভারি সবকিছু এক প্ল্যাটফর্মে।",
    rating: 4.6,
    totalReviews: 980,
    totalOrders: 3600,
    packages: [
  ...
  { slug: "online-doctor", title: "অনলাইন ডক্টর", titleEn: "Online Doctor", description: "ঘরে বসে অভিজ্ঞ ডাক্তারের সাথে ভিডিও কনসালটেশন। প্রেসক্রিপশন ও ফলো-আপ সুবিধা।", image: "/placeholder.svg", rating: 4.8, totalReviews: 1200, totalOrders: 8500, packages: [
  ...
  { slug: "home-doctor", title: "হোম ডক্টর", titleEn: "Home Doctor", description: "বাসায় ডাক্তার ভিজিট সার্ভিস। অসুস্থ বা বয়স্ক রোগীদের জন্য আদর্শ।", image: "/placeholder.svg", rating: 4.7, totalReviews: 850, totalOrders: 4200, packages: [
  ...
  ], reviews: [{ name: "আব্দুল হক", rating: 5, date: "১২ মার্চ ২০২৬", comment: "বাবার জন্য ডাক্তার ডেকেছিলাম। সময়মতো এসে চমৎকার সেবা দিয়েছেন।" }], features: ["হোম ভিজিট", "প্রেসক্রিপশন", "ফলো-আপ", "ইমার্জেন্সি সাপোর্ট"], availableCities: ["ঢাকা", "গাজীপুর", "নারায়ণগঞ্জ", "চট্টগ্রাম"] },
  { slug: "health-checkup", title: "হেলথ চেকআপ", titleEn: "Health Checkup", description: "সম্পূর্ণ স্বাস্থ্য পরীক্ষা প্যাকেজ। সকল বয়সের জন্য কাস্টমাইজড প্ল্যান।", image: "/placeholder.svg", rating: 4.6, totalReviews: 680, totalOrders: 3500, packages: [
  ...
  { slug: "ambulance-ac", title: "এসি এম্বুল্যান্স", titleEn: "AC Ambulance", description: "এয়ার কন্ডিশনড এম্বুল্যান্স সার্ভিস। জরুরি ও নন-ইমার্জেন্সি রোগী পরিবহন।", image: "/placeholder.svg", rating: 4.9, totalReviews: 420, totalOrders: 2800, packages: [
  ...
  { slug: "icu-ambulance", title: "ICU এম্বুল্যান্স", titleEn: "ICU Ambulance", description: "ICU সুবিধাযুক্ত এম্বুল্যান্স। ক্রিটিক্যাল কেয়ার রোগী পরিবহনের জন্য।", image: "/placeholder.svg", rating: 4.9, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  ], reviews: [{ name: "মোঃ জাহিদ", rating: 5, date: "৫ মার্চ ২০২৬", comment: "মায়ের জন্য ICU এম্বুল্যান্স লেগেছিল। দ্রুত সেবা পেয়েছি।" }], features: ["ICU সেটআপ", "ভেন্টিলেটর", "কার্ডিয়াক মনিটর", "২৪/৭ সার্ভিস"], availableCities: ["ঢাকা", "গাজীপুর", "নারায়ণগঞ্জ", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "সিলেট"] },

  // --- Home Service ---
  { slug: "maid-service", title: "কাজের বুয়া", titleEn: "Maid Service", description: "বিশ্বস্ত ও ভেরিফাইড কাজের বুয়া সার্ভিস। দৈনিক, সাপ্তাহিক বা মাসিক ভিত্তিতে।", image: "/placeholder.svg", rating: 4.5, totalReviews: 1500, totalOrders: 9500, packages: [
  ...
  { slug: "cook-service", title: "রাঁধুনি সার্ভিস", titleEn: "Cook Service", description: "দক্ষ রাঁধুনি সার্ভিস। বাড়ির রান্না, পার্টি কেটারিং বা ইভেন্ট রান্নার জন্য।", image: "/placeholder.svg", rating: 4.6, totalReviews: 780, totalOrders: 4200, packages: [
  ...
  { slug: "babysitter", title: "বেবিসিটার", titleEn: "Babysitter", description: "প্রশিক্ষিত ও বিশ্বস্ত বেবিসিটার সার্ভিস। আপনার শিশুর যত্নে নিরাপদ হাত।", image: "/placeholder.svg", rating: 4.7, totalReviews: 920, totalOrders: 5100, packages: [
  ...
  { slug: "wash-iron", title: "ওয়াশ অ্যান্ড আয়রন", titleEn: "Wash & Iron", description: "প্রফেশনাল লন্ড্রি সার্ভিস। কাপড় ধোয়া ও ইস্ত্রি পিকআপ ও ডেলিভারি সহ।", image: "/placeholder.svg", rating: 4.5, totalReviews: 650, totalOrders: 3800, packages: [
  ...
  { slug: "dry-cleaning", title: "ড্রাই ক্লিনিং", titleEn: "Dry Cleaning", description: "প্রিমিয়াম ড্রাই ক্লিনিং সার্ভিস। স্যুট, শাড়ি, জ্যাকেট সবকিছুর যত্ন।", image: "/placeholder.svg", rating: 4.6, totalReviews: 420, totalOrders: 2500, packages: [
  ...
  { slug: "washing-service", title: "ওয়াশিং মেশিন সার্ভিস", titleEn: "Washing Service", description: "ওয়াশিং মেশিনে বাল্ক লন্ড্রি সার্ভিস। কম্বল, পর্দা, বেডশিট ধোয়ার জন্য।", image: "/placeholder.svg", rating: 4.4, totalReviews: 380, totalOrders: 2100, packages: [
  ...
  { slug: "tiffin-service", title: "টিফিন সার্ভিস", titleEn: "Tiffin Service", description: "হোমমেড টিফিন সার্ভিস। অফিস বা বাসায় দুপুরে স্বাস্থ্যকর ঘরোয়া খাবার।", image: "/placeholder.svg", rating: 4.5, totalReviews: 560, totalOrders: 3200, packages: [
  ...
  // --- Vehicle Rental ---
  { slug: "covered-van", title: "কাভার্ড ভ্যান", titleEn: "Covered Van", description: "পণ্য পরিবহনের জন্য কাভার্ড ভ্যান ভাড়া। নিরাপদ ও সময়মতো ডেলিভারি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 520, totalOrders: 3100, packages: [
  ...
  { slug: "truck-rental", title: "ট্রাক ভাড়া", titleEn: "Truck Rental", description: "ভারী মালামাল পরিবহনের জন্য ট্রাক ভাড়া। শিল্প ও বাণিজ্যিক পরিবহন।", image: "/placeholder.svg", rating: 4.5, totalReviews: 380, totalOrders: 2200, packages: [
  ...
  { slug: "pickup-van", title: "পিকআপ ভ্যান", titleEn: "Pickup Van", description: "ছোট মালামাল পরিবহনের জন্য পিকআপ ভ্যান। দ্রুত ও সাশ্রয়ী।", image: "/placeholder.svg", rating: 4.5, totalReviews: 450, totalOrders: 2800, packages: [
  ...
  { slug: "microbus-rent", title: "মাইক্রোবাস ভাড়া", titleEn: "Microbus Rent", description: "পরিবার বা গ্রুপ ট্রিপের জন্য মাইক্রোবাস ভাড়া। ড্রাইভার সহ আরামদায়ক যাত্রা।", image: "/placeholder.svg", rating: 4.7, totalReviews: 680, totalOrders: 4500, packages: [
  ...
  { slug: "luxury-rent", title: "লাক্সারি কার ভাড়া", titleEn: "Luxury Car Rent", description: "বিয়ে, ইভেন্ট বা বিজনেসের জন্য লাক্সারি গাড়ি ভাড়া।", image: "/placeholder.svg", rating: 4.8, totalReviews: 320, totalOrders: 1800, packages: [
  ...
  { slug: "sedan-rent", title: "সেডান কার ভাড়া", titleEn: "Sedan Car Rent", description: "দৈনন্দিন ব্যবহার, অফিস যাতায়াত বা শহরের ভেতর চলাফেরার জন্য সেডান গাড়ি।", image: "/placeholder.svg", rating: 4.5, totalReviews: 450, totalOrders: 2800, packages: [
  ...
  { slug: "bike-rent", title: "বাইক ভাড়া", titleEn: "Bike Rent", description: "শহরে দ্রুত চলাফেরার জন্য বাইক ভাড়া। হেলমেট ও ইন্স্যুরেন্স সহ।", image: "/placeholder.svg", rating: 4.4, totalReviews: 350, totalOrders: 2100, packages: [
  ...
  { slug: "cycle-rent", title: "সাইকেল ভাড়া", titleEn: "Cycle Rent", description: "স্বাস্থ্যকর ও পরিবেশবান্ধব যাতায়াতের জন্য সাইকেল ভাড়া।", image: "/placeholder.svg", rating: 4.3, totalReviews: 220, totalOrders: 1200, packages: [
  ...
  // --- IT & Web ---
  { slug: "website-development", title: "ওয়েবসাইট ডেভেলপমেন্ট", titleEn: "Website Development", description: "কাস্টম ওয়েবসাইট ডিজাইন ও ডেভেলপমেন্ট। ব্যবসা, ই-কমার্স বা পোর্টফোলিও।", image: "/placeholder.svg", rating: 4.8, totalReviews: 450, totalOrders: 2200, packages: [
  ...
  { slug: "graphics-design", title: "গ্রাফিক্স ডিজাইন", titleEn: "Graphics Design", description: "লোগো, ব্যানার, সোশ্যাল মিডিয়া পোস্ট, ব্রোশিওর ইত্যাদি গ্রাফিক্স ডিজাইন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 620, totalOrders: 3800, packages: [
  ...
  { slug: "digital-marketing", title: "ডিজিটাল মার্কেটিং", titleEn: "Digital Marketing", description: "সোশ্যাল মিডিয়া মার্কেটিং, Google Ads, Facebook Ads ও কন্টেন্ট মার্কেটিং।", image: "/placeholder.svg", rating: 4.6, totalReviews: 380, totalOrders: 1800, packages: [
  ...
  { slug: "computer-repair", title: "কম্পিউটার রিপেয়ার", titleEn: "Computer Repair", description: "ডেস্কটপ ও ল্যাপটপ রিপেয়ার, আপগ্রেড, ভাইরাস রিমুভাল ও ডেটা রিকভারি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 520, totalOrders: 3200, packages: [
  ...
  { slug: "data-recovery", title: "ডেটা রিকভারি", titleEn: "Data Recovery", description: "হারানো বা ডিলিট হওয়া ডেটা পুনরুদ্ধার। হার্ড ড্রাইভ, পেনড্রাইভ, মেমরি কার্ড।", image: "/placeholder.svg", rating: 4.7, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  { slug: "networking", title: "নেটওয়ার্কিং", titleEn: "Networking", description: "অফিস ও বাসার নেটওয়ার্ক সেটআপ। WiFi, LAN, সার্ভার কনফিগারেশন।", image: "/placeholder.svg", rating: 4.5, totalReviews: 320, totalOrders: 1800, packages: [
  ...
  { slug: "software-development", title: "সফটওয়্যার ডেভেলপমেন্ট", titleEn: "Software Development", description: "কাস্টম সফটওয়্যার, মোবাইল অ্যাপ, ERP ও ম্যানেজমেন্ট সিস্টেম ডেভেলপমেন্ট।", image: "/placeholder.svg", rating: 4.8, totalReviews: 220, totalOrders: 850, packages: [
  ...
  { slug: "seo-service", title: "SEO সার্ভিস", titleEn: "SEO Service", description: "সার্চ ইঞ্জিন অপটিমাইজেশন। গুগলে আপনার ওয়েবসাইটকে টপে আনুন।", image: "/placeholder.svg", rating: 4.6, totalReviews: 280, totalOrders: 1200, packages: [
  ...
  { slug: "cyber-security", title: "সাইবার সিকিউরিটি", titleEn: "Cyber Security", description: "ওয়েবসাইট, সার্ভার ও নেটওয়ার্ক সিকিউরিটি অডিট ও প্রোটেকশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 180, totalOrders: 650, packages: [
  ...
  { slug: "ui-ux-design", title: "UI/UX ডিজাইন", titleEn: "UI/UX Design", description: "ইউজার ইন্টারফেস ও ইউজার এক্সপেরিয়েন্স ডিজাইন। অ্যাপ ও ওয়েব।", image: "/placeholder.svg", rating: 4.7, totalReviews: 250, totalOrders: 1100, packages: [
  ...
  { slug: "domain-hosting", title: "ডোমেইন ও হোস্টিং", titleEn: "Domain & Hosting", description: "ডোমেইন রেজিস্ট্রেশন, ওয়েব হোস্টিং, ইমেইল হোস্টিং ও SSL সার্টিফিকেট।", image: "/placeholder.svg", rating: 4.5, totalReviews: 420, totalOrders: 2500, packages: [
  ...
  // --- Event Management ---
  { slug: "wedding-planning", title: "বিয়ের প্ল্যানিং", titleEn: "Wedding Planning", description: "সম্পূর্ণ বিয়ের আয়োজন। ভেন্যু, ক্যাটারিং, ডেকোরেশন সব এক প্যাকেজে।", image: "/placeholder.svg", rating: 4.8, totalReviews: 350, totalOrders: 1200, packages: [
  ...
  { slug: "wedding-catering", title: "বিয়ের ক্যাটারিং", titleEn: "Wedding Catering", description: "বিয়ের অনুষ্ঠানে প্রফেশনাল ক্যাটারিং সার্ভিস। বাংলাদেশি ও ইন্টারন্যাশনাল মেনু।", image: "/placeholder.svg", rating: 4.7, totalReviews: 480, totalOrders: 2200, packages: [
  ...
  { slug: "wedding-photography", title: "ওয়েডিং ফটোগ্রাফি", titleEn: "Wedding Photography", description: "বিয়ের দিনের মূল্যবান মুহূর্তগুলো ধরে রাখুন প্রফেশনাল ফটোগ্রাফির মাধ্যমে।", image: "/placeholder.svg", rating: 4.8, totalReviews: 520, totalOrders: 2800, packages: [
  ...
  { slug: "birthday-event", title: "বার্থডে ইভেন্ট", titleEn: "Birthday Event", description: "জন্মদিনের অনুষ্ঠান আয়োজন। থিম ডেকোরেশন, কেক, এন্টারটেইনমেন্ট।", image: "/placeholder.svg", rating: 4.6, totalReviews: 380, totalOrders: 2100, packages: [
  ...
  { slug: "corporate-event", title: "কর্পোরেট ইভেন্ট", titleEn: "Corporate Event", description: "কোম্পানির সেমিনার, কনফারেন্স, প্রোডাক্ট লঞ্চ ও টিম বিল্ডিং ইভেন্ট।", image: "/placeholder.svg", rating: 4.7, totalReviews: 220, totalOrders: 800, packages: [
  ...
  { slug: "party-catering", title: "পার্টি ক্যাটারিং", titleEn: "Party Catering", description: "পার্টি ও ইভেন্টের জন্য প্রফেশনাল ক্যাটারিং সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 350, totalOrders: 1800, packages: [
  ...
  { slug: "stage-decoration", title: "স্টেজ ডেকোরেশন", titleEn: "Stage Decoration", description: "বিয়ে, কনসার্ট, কর্পোরেট ইভেন্টের জন্য প্রফেশনাল স্টেজ ডেকোরেশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  { slug: "sound-lighting", title: "সাউন্ড ও লাইটিং", titleEn: "Sound & Lighting", description: "ইভেন্টের জন্য প্রফেশনাল সাউন্ড সিস্টেম ও লাইটিং সেটআপ।", image: "/placeholder.svg", rating: 4.6, totalReviews: 320, totalOrders: 1800, packages: [
  ...
  { slug: "event-mc", title: "ইভেন্ট MC/হোস্ট", titleEn: "Event MC/Host", description: "ইভেন্ট উপস্থাপক ও MC সার্ভিস। বিয়ে, কর্পোরেট বা সাংস্কৃতিক অনুষ্ঠানের জন্য।", image: "/placeholder.svg", rating: 4.7, totalReviews: 220, totalOrders: 950, packages: [
  ...
  { slug: "concert-cultural", title: "কনসার্ট ও সাংস্কৃতিক", titleEn: "Concert & Cultural", description: "কনসার্ট, সাংস্কৃতিক অনুষ্ঠান ও লাইভ পারফরম্যান্স আয়োজন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 180, totalOrders: 600, packages: [
  ...
  { slug: "fair-management", title: "মেলা পরিচালনা", titleEn: "Fair Management", description: "বাণিজ্য মেলা, বইমেলা, খাদ্য মেলা ইত্যাদির সম্পূর্ণ আয়োজন ও পরিচালনা।", image: "/placeholder.svg", rating: 4.6, totalReviews: 150, totalOrders: 450, packages: [
  ...
  // --- Media Production ---
  { slug: "drama-production", title: "নাটক প্রোডাকশন", titleEn: "Drama Production", description: "টেলিভিশন ও ওয়েব নাটক প্রোডাকশন সার্ভিস।", image: "/placeholder.svg", rating: 4.7, totalReviews: 120, totalOrders: 350, packages: [
  ...
  { slug: "commercial-production", title: "কমার্শিয়াল প্রোডাকশন", titleEn: "Commercial Production", description: "টিভি কমার্শিয়াল, ব্র্যান্ড ভিডিও ও প্রোডাক্ট শুটিং।", image: "/placeholder.svg", rating: 4.8, totalReviews: 180, totalOrders: 650, packages: [
  ...
  { slug: "web-series", title: "ওয়েব সিরিজ", titleEn: "Web Series", description: "YouTube ও OTT প্ল্যাটফর্মের জন্য ওয়েব সিরিজ প্রোডাকশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 100, totalOrders: 250, packages: [
  ...
  { slug: "short-film", title: "শর্ট ফিল্ম", titleEn: "Short Film", description: "ক্রিয়েটিভ শর্ট ফিল্ম প্রোডাকশন। ফেস্টিভ্যাল সাবমিশন ও অনলাইন রিলিজ।", image: "/placeholder.svg", rating: 4.7, totalReviews: 150, totalOrders: 400, packages: [
  ...
  { slug: "documentary", title: "ডকুমেন্টারি", titleEn: "Documentary", description: "ডকুমেন্টারি ফিল্ম প্রোডাকশন। সামাজিক, পরিবেশ, ইতিহাস বিষয়ক।", image: "/placeholder.svg", rating: 4.8, totalReviews: 90, totalOrders: 200, packages: [
  ...
  { slug: "music-video", title: "মিউজিক ভিডিও", titleEn: "Music Video", description: "প্রফেশনাল মিউজিক ভিডিও প্রোডাকশন। পপ, রক, ক্লাসিক্যাল সব জনরায়।", image: "/placeholder.svg", rating: 4.7, totalReviews: 220, totalOrders: 800, packages: [
  ...
  { slug: "music-production", title: "মিউজিক প্রোডাকশন", titleEn: "Music Production", description: "গান রেকর্ডিং, মিক্সিং, মাস্টারিং ও মিউজিক কম্পোজিশন।", image: "/placeholder.svg", rating: 4.8, totalReviews: 180, totalOrders: 650, packages: [
  ...
  { slug: "voice-artist", title: "ভয়েস আর্টিস্ট", titleEn: "Voice Artist", description: "ভয়েসওভার, ডাবিং, অডিওবুক ও IVR রেকর্ডিং সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 250, totalOrders: 1200, packages: [
  ...
  { slug: "product-photography", title: "প্রোডাক্ট ফটোগ্রাফি", titleEn: "Product Photography", description: "ই-কমার্স ও ক্যাটালগের জন্য প্রফেশনাল প্রোডাক্ট ফটোগ্রাফি।", image: "/placeholder.svg", rating: 4.7, totalReviews: 320, totalOrders: 1800, packages: [
  ...
  // --- Education ---
  { slug: "home-tutor", title: "হোম টিউটর", titleEn: "Home Tutor", description: "যোগ্য ও অভিজ্ঞ হোম টিউটর সার্ভিস। সকল ক্লাস ও বিষয়ের জন্য।", image: "/placeholder.svg", rating: 4.6, totalReviews: 1200, totalOrders: 8500, packages: [
  ...
  { slug: "online-coaching", title: "অনলাইন কোচিং", titleEn: "Online Coaching", description: "ঘরে বসে অনলাইন কোচিং। লাইভ ক্লাস, রেকর্ডেড ভিডিও ও প্র্যাকটিস টেস্ট।", image: "/placeholder.svg", rating: 4.5, totalReviews: 850, totalOrders: 5500, packages: [
  ...
  { slug: "quran-tutor", title: "কোরআন শিক্ষা", titleEn: "Quran Tutor", description: "অভিজ্ঞ হাফেজ/ক্বারী দ্বারা কোরআন শিক্ষা। তাজবিদ, হিফজ ও তাফসির।", image: "/placeholder.svg", rating: 4.8, totalReviews: 680, totalOrders: 4200, packages: [
  ...
  { slug: "skilled-worker", title: "দক্ষ শ্রমিক", titleEn: "Skilled Worker", description: "প্রশিক্ষিত ও দক্ষ শ্রমিক সরবরাহ। নির্মাণ, ফ্যাক্টরি ও শিল্প কাজের জন্য।", image: "/placeholder.svg", rating: 4.4, totalReviews: 280, totalOrders: 1600, packages: [
  ...
  { slug: "daily-labor", title: "দৈনিক শ্রমিক", titleEn: "Daily Labor", description: "দৈনিক ভিত্তিতে শ্রমিক সরবরাহ। বাসা, অফিস বা প্রজেক্টের কাজে।", image: "/placeholder.svg", rating: 4.3, totalReviews: 350, totalOrders: 2500, packages: [
  ...
  // --- Legal ---
  { slug: "legal-consultation", title: "আইনি পরামর্শ", titleEn: "Legal Consultation", description: "অভিজ্ঞ আইনজীবীর কাছ থেকে আইনি পরামর্শ। পারিবারিক, ব্যবসায়িক ও ফৌজদারি।", image: "/placeholder.svg", rating: 4.7, totalReviews: 320, totalOrders: 1500, packages: [
  ...
  { slug: "document-drafting", title: "ডকুমেন্ট ড্রাফটিং", titleEn: "Document Drafting", description: "আইনি ডকুমেন্ট তৈরি। চুক্তিপত্র, উকিলনামা, পাওয়ার অব অ্যাটর্নি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 250, totalOrders: 1200, packages: [
  ...
  // --- Security ---
  { slug: "security-guard", title: "সিকিউরিটি গার্ড", titleEn: "Security Guard", description: "প্রশিক্ষিত সিকিউরিটি গার্ড সার্ভিস। বাসা, অফিস, ফ্যাক্টরি ও ইভেন্টের জন্য।", image: "/placeholder.svg", rating: 4.5, totalReviews: 380, totalOrders: 2200, packages: [
  ...
  { slug: "event-security", title: "ইভেন্ট সিকিউরিটি", titleEn: "Event Security", description: "ইভেন্ট, কনসার্ট ও জমায়েতের জন্য সিকিউরিটি ম্যানেজমেন্ট।", image: "/placeholder.svg", rating: 4.6, totalReviews: 180, totalOrders: 800, packages: [
  ...
  { slug: "fire-alarm-system", title: "ফায়ার অ্যালার্ম সিস্টেম", titleEn: "Fire Alarm System", description: "ফায়ার অ্যালার্ম, স্মোক ডিটেক্টর ও ফায়ার সেফটি সিস্টেম ইনস্টলেশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 220, totalOrders: 1200, packages: [
  ...
  { slug: "fire-extinguisher", title: "ফায়ার এক্সটিংগুইশার", titleEn: "Fire Extinguisher", description: "ফায়ার এক্সটিংগুইশার বিক্রি, রিফিলিং ও মেইনটেন্যান্স সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 180, totalOrders: 950, packages: [
  ...
  // --- Construction ---
  { slug: "building-construction", title: "ভবন নির্মাণ", titleEn: "Building Construction", description: "আবাসিক ও বাণিজ্যিক ভবন নির্মাণ সার্ভিস। ডিজাইন থেকে সমাপ্তি পর্যন্ত।", image: "/placeholder.svg", rating: 4.7, totalReviews: 180, totalOrders: 450, packages: [
  ...
  { slug: "renovation", title: "রেনোভেশন", titleEn: "Renovation", description: "বাসা ও অফিস রেনোভেশন। কিচেন, বাথরুম, ফ্লোরিং রিমডেলিং।", image: "/placeholder.svg", rating: 4.6, totalReviews: 320, totalOrders: 1800, packages: [
  ...
  { slug: "lift-installation", title: "লিফট ইনস্টলেশন", titleEn: "Lift Installation", description: "প্যাসেঞ্জার ও কার্গো লিফট ইনস্টলেশন সার্ভিস।", image: "/placeholder.svg", rating: 4.7, totalReviews: 120, totalOrders: 350, packages: [
  ...
  { slug: "lift-maintenance", title: "লিফট মেইনটেন্যান্স", titleEn: "Lift Maintenance", description: "লিফটের নিয়মিত রক্ষণাবেক্ষণ ও মেরামত সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 180, totalOrders: 800, packages: [
  ...
  { slug: "bathroom-waterproofing", title: "বাথরুম ওয়াটারপ্রুফিং", titleEn: "Bathroom Waterproofing", description: "বাথরুম, ছাদ ও বেসমেন্ট ওয়াটারপ্রুফিং সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 250, totalOrders: 1400, packages: [
  ...
  { slug: "fridge-service", title: "ফ্রিজ সার্ভিসিং", titleEn: "Fridge Service", description: "ফ্রিজ রিপেয়ার, গ্যাস রিফিল ও সার্ভিসিং। সকল ব্র্যান্ড।", image: "/placeholder.svg", rating: 4.6, totalReviews: 450, totalOrders: 2800, packages: [
  ...
  { slug: "generator-service", title: "জেনারেটর সার্ভিস", titleEn: "Generator Service", description: "জেনারেটর ইনস্টলেশন, সার্ভিসিং ও রিপেয়ার।", image: "/placeholder.svg", rating: 4.5, totalReviews: 220, totalOrders: 1200, packages: [
  ...
  { slug: "ips-ups-service", title: "IPS/UPS সার্ভিস", titleEn: "IPS/UPS Service", description: "IPS, UPS ও ব্যাটারি ইনস্টলেশন, রিপেয়ার ও মেইনটেন্যান্স।", image: "/placeholder.svg", rating: 4.5, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  { slug: "mobile-battery", title: "মোবাইল ব্যাটারি", titleEn: "Mobile Battery", description: "মোবাইল ফোনের ব্যাটারি রিপ্লেসমেন্ট সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 520, totalOrders: 3500, packages: [
  ...
  { slug: "mobile-screen", title: "মোবাইল স্ক্রিন", titleEn: "Mobile Screen", description: "মোবাইল ফোনের ভাঙা ডিসপ্লে রিপ্লেসমেন্ট সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 680, totalOrders: 4500, packages: [
  ...
  // --- Solar ---
  { slug: "solar-installation", title: "সোলার ইনস্টলেশন", titleEn: "Solar Installation", description: "সোলার প্যানেল ইনস্টলেশন সার্ভিস। বাসা, অফিস ও শিল্প প্রতিষ্ঠানের জন্য।", image: "/placeholder.svg", rating: 4.7, totalReviews: 280, totalOrders: 1200, packages: [
  ...
  { slug: "solar-maintenance", title: "সোলার মেইনটেন্যান্স", titleEn: "Solar Maintenance", description: "সোলার প্যানেল ক্লিনিং, চেকআপ ও রিপেয়ার সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 180, totalOrders: 800, packages: [
  ...
  // --- Agriculture ---
  { slug: "agri-consulting", title: "কৃষি পরামর্শ", titleEn: "Agri Consulting", description: "কৃষি বিশেষজ্ঞদের পরামর্শ। ফসল, মাটি, সার ও কীটনাশক।", image: "/placeholder.svg", rating: 4.5, totalReviews: 220, totalOrders: 1100, packages: [
  ...
  { slug: "livestock-care", title: "প্রাণিসেবা", titleEn: "Livestock Care", description: "গবাদি পশু ও পোল্ট্রির চিকিৎসা, টিকাদান ও পরামর্শ সেবা।", image: "/placeholder.svg", rating: 4.5, totalReviews: 180, totalOrders: 900, packages: [
  ...
  ], reviews: [{ name: "মাসুদুর রহমান", rating: 4, date: "৯ মার্চ ২০২৬", comment: "গরুর চিকিৎসায় দ্রুত সেবা পেয়েছি।" }], features: ["অভিজ্ঞ ভেটেরিনারি", "হোম ভিজিট", "ভ্যাকসিনেশন", "ফার্ম কনসাল্টিং"], availableCities: ["ঢাকা", "গাজীপুর", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "বরিশাল", "রংপুর"] },
  { slug: "garden-maintenance", title: "গার্ডেন মেইনটেন্যান্স", titleEn: "Garden Maintenance", description: "বাগান পরিচর্যা সার্ভিস। ছাদবাগান, লন ও ফুলের বাগান।", image: "/placeholder.svg", rating: 4.4, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  { slug: "landscape-design", title: "ল্যান্ডস্কেপ ডিজাইন", titleEn: "Landscape Design", description: "বাড়ি, অফিস ও রিসোর্টের জন্য ল্যান্ডস্কেপ ডিজাইন ও এক্সিকিউশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 150, totalOrders: 600, packages: [
  ...
  // --- Travel ---
  { slug: "air-ticket", title: "এয়ার টিকেট", titleEn: "Air Ticket", description: "দেশীয় ও আন্তর্জাতিক এয়ার টিকেট বুকিং। সেরা দামে ফ্লাইট।", image: "/placeholder.svg", rating: 4.6, totalReviews: 520, totalOrders: 3500, packages: [
  ...
  { slug: "visa-processing", title: "ভিসা প্রসেসিং", titleEn: "Visa Processing", description: "সকল দেশের ভিসা আবেদন ও প্রসেসিং সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 380, totalOrders: 2200, packages: [
  ...
  { slug: "tour-package", title: "ট্যুর প্যাকেজ", titleEn: "Tour Package", description: "দেশীয় ও আন্তর্জাতিক ট্যুর প্যাকেজ। হোটেল, ট্রান্সপোর্ট ও গাইড সহ।", image: "/placeholder.svg", rating: 4.7, totalReviews: 450, totalOrders: 2800, packages: [
  ...
  // --- Tailoring ---
  { slug: "ladies-tailoring", title: "লেডিস টেইলারিং", titleEn: "Ladies Tailoring", description: "লেডিস পোশাক সেলাই সার্ভিস। শাড়ি ব্লাউজ, সালোয়ার কামিজ, ওয়েস্টার্ন।", image: "/placeholder.svg", rating: 4.6, totalReviews: 450, totalOrders: 2800, packages: [
  ...
  { slug: "gents-tailoring", title: "জেন্টস টেইলারিং", titleEn: "Gents Tailoring", description: "পুরুষদের পোশাক সেলাই। শার্ট, প্যান্ট, স্যুট, পাঞ্জাবি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 380, totalOrders: 2200, packages: [
  ...
  { slug: "alteration", title: "অল্টারেশন", titleEn: "Alteration", description: "পোশাক মেরামত ও অল্টারেশন সার্ভিস। সাইজ অ্যাডজাস্ট, জিপ বদল।", image: "/placeholder.svg", rating: 4.4, totalReviews: 520, totalOrders: 3500, packages: [
  ...
  { slug: "cctv-installation", title: "সিসিটিভি ইনস্টলেশন", titleEn: "CCTV Installation", description: "বাসা, অফিস, দোকান ও ফ্যাক্টরিতে সিসিটিভি ক্যামেরা ইনস্টলেশন, মনিটরিং ও মেইনটেন্যান্স সার্ভিস।", image: "/placeholder.svg", rating: 4.7, totalReviews: 520, totalOrders: 3200, packages: [
  ...
  { slug: "water-purifier", title: "ওয়াটার পিউরিফায়ার", titleEn: "Water Purifier", description: "ওয়াটার পিউরিফায়ার ইনস্টলেশন, সার্ভিসিং, ফিল্টার চেঞ্জ ও রিপেয়ার সার্ভিস। RO, UV, UF সকল প্রকার।", image: "/placeholder.svg", rating: 4.6, totalReviews: 680, totalOrders: 4500, packages: [
  ...
  { slug: "water-tank-cleaning", title: "ওয়াটার ট্যাংক ক্লিনিং", titleEn: "Water Tank Cleaning", description: "বাসা ও অ্যাপার্টমেন্টের ওভারহেড ও আন্ডারগ্রাউন্ড ওয়াটার ট্যাংক পরিষ্কার ও জীবাণুমুক্ত করার সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 420, totalOrders: 2800, packages: [
  ...
  ], reviews: [{ name: "মোঃ আলাউদ্দিন", rating: 5, date: "১০ মার্চ ২০২৬", comment: "ট্যাংক ক্লিনিংয়ের পর পানির গুণমান অনেক ভালো হয়েছে।" }], features: ["প্রফেশনাল ক্লিনিং", "জীবাণুমুক্ত", "ওয়াটার টেস্ট", "নিয়মিত সেবা"], availableCities: ["ঢাকা", "গাজীপুর", "নারায়ণগঞ্জ", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "সিলেট"] },

  { slug: "tiles-marble", title: "টাইলস ও মার্বেল ওয়ার্ক", titleEn: "Tiles & Marble Work", description: "ফ্লোর টাইলস, ওয়াল টাইলস, মার্বেল ও গ্রানাইট ফিটিং, পলিশিং ও রিপেয়ার সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 380, totalOrders: 2200, packages: [
  ...
  { slug: "welding-grill", title: "ওয়েল্ডিং ও গ্রিল", titleEn: "Welding & Grill", description: "লোহার গ্রিল, গেট, রেলিং তৈরি ও ওয়েল্ডিং রিপেয়ার সার্ভিস। গ্লাস ও এলুমিনিয়াম কাজও করা হয়।", image: "/placeholder.svg", rating: 4.5, totalReviews: 350, totalOrders: 2000, packages: [
  ...
  { slug: "glass-aluminum", title: "গ্লাস ও এলুমিনিয়াম", titleEn: "Glass & Aluminum", description: "থাই গ্লাস, মিরর, শাওয়ার গ্লাস, এলুমিনিয়াম দরজা-জানালা তৈরি ও ফিটিং সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 280, totalOrders: 1500, packages: [
  ...
  { slug: "septic-tank", title: "সেপটিক ট্যাংক ক্লিনিং", titleEn: "Septic Tank Cleaning", description: "সেপটিক ট্যাংক ও ড্রেইন পরিষ্কার সার্ভিস। ভ্যাকুয়াম ট্রাক দ্বারা দ্রুত ও স্বাস্থ্যসম্মত সেবা।", image: "/placeholder.svg", rating: 4.4, totalReviews: 320, totalOrders: 2100, packages: [
  ...
  { slug: "mosquito-net", title: "মশার নেট ও স্ক্রিন", titleEn: "Mosquito Net & Screen", description: "দরজা-জানালায় মশার নেট, ম্যাগনেটিক স্ক্রিন ও ইনসেক্ট স্ক্রিন ফিটিং সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 420, totalOrders: 2800, packages: [
  ...
  { slug: "passport-nid", title: "পাসপোর্ট ও NID সেবা", titleEn: "Passport & NID Service", description: "পাসপোর্ট নবায়ন, NID সংশোধন, জন্ম নিবন্ধন ও সরকারি কাগজপত্র প্রক্রিয়াকরণ সহায়তা।", image: "/placeholder.svg", rating: 4.7, totalReviews: 1800, totalOrders: 12000, packages: [
  ...
  { slug: "birth-certificate", title: "জন্ম নিবন্ধন", titleEn: "Birth Certificate", description: "জন্ম নিবন্ধন, সংশোধন ও ডুপ্লিকেট সনদ প্রাপ্তিতে সহায়তা।", image: "/placeholder.svg", rating: 4.6, totalReviews: 950, totalOrders: 6500, packages: [
  ...
  // --- Printing & Stationery ---
  { slug: "printing-binding", title: "প্রিন্টিং ও বাইন্ডিং", titleEn: "Printing & Binding", description: "ডকুমেন্ট প্রিন্ট, ফটোকপি, স্পাইরাল বাইন্ডিং, লেমিনেটিং ও ব্যানার প্রিন্ট।", image: "/placeholder.svg", rating: 4.5, totalReviews: 680, totalOrders: 4500, packages: [
  ...
  // --- Custom Furniture ---
  { slug: "custom-furniture", title: "কাস্টম ফার্নিচার", titleEn: "Custom Furniture", description: "কাঠ ও বোর্ডের কাস্টম ফার্নিচার তৈরি। আলমারি, খাট, টেবিল, কিচেন ক্যাবিনেট।", image: "/placeholder.svg", rating: 4.7, totalReviews: 850, totalOrders: 4800, packages: [
  ...
  // --- Standalone Catering ---
  { slug: "catering-service", title: "ক্যাটারিং সার্ভিস", titleEn: "Catering Service", description: "বাড়ির অনুষ্ঠান, অফিস মিটিং, পার্টি ও যেকোনো ইভেন্টের জন্য ক্যাটারিং সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 1100, totalOrders: 7200, packages: [
  ...
  // --- Fitness ---
  { slug: "personal-trainer", title: "পার্সোনাল ট্রেইনার", titleEn: "Personal Trainer", description: "বাসায় বা জিমে পার্সোনাল ফিটনেস ট্রেইনার। ডায়েট প্ল্যান ও ওয়ার্কআউট গাইডেন্স।", image: "/placeholder.svg", rating: 4.7, totalReviews: 520, totalOrders: 3200, packages: [
  ...
  // --- Photography (General) ---
  { slug: "photography-service", title: "ফটোগ্রাফি সার্ভিস", titleEn: "Photography Service", description: "পোর্ট্রেট, ফ্যামিলি, গ্র্যাজুয়েশন, প্রি-ওয়েডিং ও ইভেন্ট ফটোগ্রাফি।", image: "/placeholder.svg", rating: 4.8, totalReviews: 780, totalOrders: 5200, packages: [
  ...
  // --- Pet Care ---
  { slug: "pet-care", title: "পেট কেয়ার", titleEn: "Pet Care", description: "পোষা প্রাণীর গ্রুমিং, ভ্যাক্সিনেশন, ট্রেনিং ও ভেটেরিনারি কেয়ার সার্ভিস।", image: "/placeholder.svg", rating: 4.6, totalReviews: 380, totalOrders: 2100, packages: [
  ...
  { slug: "bill-pay", title: "বিল পে ও রিচার্জ", titleEn: "Bill Pay & Recharge", description: "বিদ্যুৎ, গ্যাস, পানি, ইন্টারনেট বিল ও মোবাইল রিচার্জ সার্ভিস।", image: "/placeholder.svg", rating: 4.4, totalReviews: 2200, totalOrders: 15000, packages: [
  ...
  { slug: "flat-rent", title: "ফ্ল্যাট ভাড়া", titleEn: "Flat Rent", description: "বাসা/ফ্ল্যাট ভাড়ার জন্য ভেরিফাইড লিস্টিং। পরিবার, ব্যাচেলর ও অফিসের জন্য।", image: "/placeholder.svg", rating: 4.6, totalReviews: 2500, totalOrders: 18000, packages: [
  ...
  { slug: "property-buy-sell", title: "জমি ও প্রপার্টি ক্রয়-বিক্রয়", titleEn: "Property Buy & Sell", description: "জমি, ফ্ল্যাট, বাড়ি ও কমার্শিয়াল প্রপার্টি ক্রয়-বিক্রয় সেবা।", image: "/placeholder.svg", rating: 4.5, totalReviews: 1200, totalOrders: 5500, packages: [
  ...
  // --- Blood & Emergency ---
  { slug: "blood-bank", title: "ব্লাড ব্যাংক ও ডোনার", titleEn: "Blood Bank & Donor", description: "জরুরি রক্তের প্রয়োজনে ব্লাড ব্যাংক ও স্বেচ্ছাসেবী ডোনার খুঁজুন।", image: "/placeholder.svg", rating: 4.9, totalReviews: 3200, totalOrders: 25000, packages: [
  ...
  { slug: "oxygen-cylinder", title: "অক্সিজেন সিলিন্ডার", titleEn: "Oxygen Cylinder", description: "মেডিকেল অক্সিজেন সিলিন্ডার ভাড়া ও রিফিল সার্ভিস। হোম ডেলিভারি।", image: "/placeholder.svg", rating: 4.8, totalReviews: 650, totalOrders: 4200, packages: [
  ...
  { slug: "gas-cylinder", title: "গ্যাস সিলিন্ডার ডেলিভারি", titleEn: "Gas Cylinder Delivery", description: "রান্নার গ্যাস সিলিন্ডার হোম ডেলিভারি। LP গ্যাস রিফিল ও নতুন সংযোগ।", image: "/placeholder.svg", rating: 4.5, totalReviews: 1800, totalOrders: 14000, packages: [
  ...
  { slug: "jar-water", title: "জার ওয়াটার ডেলিভারি", titleEn: "Jar Water Delivery", description: "বিশুদ্ধ খাবার পানি জার ডেলিভারি। ফিল্টার্ড ও মিনারেল ওয়াটার।", image: "/placeholder.svg", rating: 4.4, totalReviews: 1500, totalOrders: 12000, packages: [
  ...
  // --- Gift & Flower ---
  { slug: "flower-delivery", title: "ফ্লাওয়ার ডেলিভারি", titleEn: "Flower Delivery", description: "তাজা ফুলের বুকে, ফুলের ঝুড়ি ও ডেকোরেশন। জন্মদিন, বিয়ে ও অনুষ্ঠানের জন্য।", image: "/placeholder.svg", rating: 4.7, totalReviews: 920, totalOrders: 6800, packages: [
  ...
  { slug: "gift-delivery", title: "গিফট ডেলিভারি", titleEn: "Gift Delivery", description: "জন্মদিন, বিবাহ বার্ষিকী, ভ্যালেন্টাইন ডে ও যেকোনো উপলক্ষে গিফট ডেলিভারি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 750, totalOrders: 5500, packages: [
  ...
  { slug: "cake-delivery", title: "কেক ও বেকারি", titleEn: "Cake & Bakery", description: "কাস্টম কেক, কাপকেক, পেস্ট্রি ও বেকারি আইটেম অর্ডার ও ডেলিভারি।", image: "/placeholder.svg", rating: 4.7, totalReviews: 1100, totalOrders: 8500, packages: [
  ...
  { slug: "tax-return", title: "ট্যাক্স রিটার্ন ফাইলিং", titleEn: "Tax Return Filing", description: "আয়কর রিটার্ন দাখিল, TIN সার্টিফিকেট ও ট্যাক্স কনসালটেশন সেবা।", image: "/placeholder.svg", rating: 4.7, totalReviews: 680, totalOrders: 3500, packages: [
  ...
  { slug: "trade-license", title: "ট্রেড লাইসেন্স ও কোম্পানি রেজি.", titleEn: "Trade License & Registration", description: "ট্রেড লাইসেন্স, কোম্পানি রেজিস্ট্রেশন, RJSC ফাইলিং ও ব্যবসায়িক লাইসেন্স সেবা।", image: "/placeholder.svg", rating: 4.6, totalReviews: 420, totalOrders: 2200, packages: [
  ...
  // --- Insurance ---
  { slug: "insurance-service", title: "ইন্স্যুরেন্স সেবা", titleEn: "Insurance Service", description: "লাইফ, হেলথ, ভেহিকেল ও প্রপার্টি ইন্স্যুরেন্স পরিকল্পনা ও ক্লেইম সাপোর্ট।", image: "/placeholder.svg", rating: 4.5, totalReviews: 380, totalOrders: 1800, packages: [
  ...
  // --- Appliance Rental ---
  { slug: "appliance-rental", title: "অ্যাপ্লায়েন্স ভাড়া", titleEn: "Appliance Rental", description: "এসি, ফ্রিজ, ওয়াশিং মেশিন, মাইক্রোওয়েভ ভাড়া নিন মাসিক ভিত্তিতে।", image: "/placeholder.svg", rating: 4.5, totalReviews: 480, totalOrders: 2800, packages: [
  ...
  { slug: "marriage-media", title: "ম্যারেজ মিডিয়া", titleEn: "Marriage Media", description: "বিশ্বস্ত ম্যাচমেকিং সেবা। বায়োডাটা ভেরিফিকেশন, পাত্র-পাত্রী খোঁজা ও পরিবার পরিচয়।", image: "/placeholder.svg", rating: 4.6, totalReviews: 2800, totalOrders: 15000, packages: [
  ...
  { slug: "bike-servicing", title: "বাইক সার্ভিসিং", titleEn: "Bike Servicing", description: "বাইক সার্ভিসিং, অয়েল চেঞ্জ, টিউনআপ ও রিপেয়ার। হোম সার্ভিস অপশন।", image: "/placeholder.svg", rating: 4.6, totalReviews: 1500, totalOrders: 9500, packages: [
  ...
  { slug: "tyre-battery", title: "টায়ার ও ব্যাটারি সার্ভিস", titleEn: "Tyre & Battery Service", description: "গাড়ি ও বাইকের টায়ার পরিবর্তন, পাংচার রিপেয়ার ও ব্যাটারি সার্ভিস।", image: "/placeholder.svg", rating: 4.5, totalReviews: 820, totalOrders: 5500, packages: [
  ...
  // --- Event Rentals ---
  { slug: "tent-pandal", title: "তাঁবু ও প্যান্ডেল ভাড়া", titleEn: "Tent & Pandal Rental", description: "বিয়ে, মিলাদ, জানাজা, মেলা ও যেকোনো অনুষ্ঠানের জন্য তাঁবু, শামিয়ানা ও প্যান্ডেল ভাড়া।", image: "/placeholder.svg", rating: 4.5, totalReviews: 950, totalOrders: 6200, packages: [
  ...
  // --- Signboard & Banner ---
  { slug: "signboard-banner", title: "সাইনবোর্ড ও ব্যানার", titleEn: "Signboard & Banner", description: "দোকান, অফিস ও ইভেন্টের জন্য LED সাইনবোর্ড, নিয়ন সাইন, ব্যানার ও ফেস্টুন তৈরি।", image: "/placeholder.svg", rating: 4.6, totalReviews: 680, totalOrders: 4500, packages: [
  ...
  // --- Remittance ---
  { slug: "money-transfer", title: "মানি ট্রান্সফার ও রেমিট্যান্স", titleEn: "Money Transfer & Remittance", description: "দেশে-বিদেশে টাকা পাঠানো ও গ্রহণ। ব্যাংক, বিকাশ, নগদ ও ওয়েস্টার্ন ইউনিয়ন।", image: "/placeholder.svg", rating: 4.5, totalReviews: 1500, totalOrders: 12000, packages: [
  ...
  // --- Wellness ---
  { slug: "yoga-meditation", title: "ইয়োগা ও মেডিটেশন", titleEn: "Yoga & Meditation", description: "প্রশিক্ষিত ইন্সট্রাক্টরের সাথে ইয়োগা, মেডিটেশন ও মাইন্ডফুলনেস সেশন।", image: "/placeholder.svg", rating: 4.7, totalReviews: 420, totalOrders: 2800, packages: [
  ...
  // --- Funeral & Religious ---
  { slug: "janaza-service", title: "জানাজা ও দাফন সেবা", titleEn: "Janaza & Burial Service", description: "জানাজার আয়োজন, গোসল, কাফন, কবর খনন ও দাফন সংক্রান্ত সকল সেবা।", image: "/placeholder.svg", rating: 4.9, totalReviews: 350, totalOrders: 2200, packages: [
    { name: "বেসিক সেবা", price: 3000, originalPrice: 5000, features: ["গোসল ও কাফন", "জানাজা আয়োজন", "কবর প্রস্তুতি"] },
    { name: "ফুল সেবা", price: 8000, originalPrice: 12000, features: ["সম্পূর্ণ আয়োজন", "এম্বুল্যান্স", "গোরস্থান বুকিং", "খাবার ব্যবস্থা"] },
  ...
  ], reviews: [{ name: "মোঃ আনোয়ার হোসেন", rating: 5, date: "১০ মার্চ ২০২৬", comment: "কঠিন সময়ে সবকিছু সুন্দরভাবে সামলে দিয়েছে। জাযাকাল্লাহ।" }], features: ["২৪/৭ সার্ভিস", "ইসলামিক রীতি অনুযায়ী", "দ্রুত সেবা", "সম্মানজনক ব্যবস্থাপনা"], availableCities: ["ঢাকা", "গাজীপুর", "নারায়ণগঞ্জ", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "সিলেট", "বরিশাল", "রংপুর", "ময়মনসিংহ", "কুমিল্লা"] },

  // --- Driving School ---
  { slug: "driving-school", title: "ড্রাইভিং স্কুল ও ট্রেনিং", titleEn: "Driving School & Training", description: "গাড়ি, বাইক ও হেভি ভেহিকেল ড্রাইভিং প্রশিক্ষণ এবং লাইসেন্স সহায়তা।", image: "/placeholder.svg", rating: 4.6, totalReviews: 820, totalOrders: 5500, packages: [
  ...
  // --- Hajj & Umrah ---
  { slug: "hajj-umrah", title: "হজ্জ ও ওমরাহ সেবা", titleEn: "Hajj & Umrah Services", description: "সম্পূর্ণ হজ্জ ও ওমরাহ প্যাকেজ — ভিসা, ফ্লাইট, হোটেল ও গাইড সহ।", image: "/placeholder.svg", rating: 4.8, totalReviews: 1200, totalOrders: 8000, packages: [
  ...
  // --- Mehendi Service ---
  { slug: "mehendi-service", title: "মেহেদী সার্ভিস", titleEn: "Mehendi / Henna Service", description: "বিয়ে, গায়ে হলুদ ও বিভিন্ন অনুষ্ঠানের জন্য প্রফেশনাল মেহেদী আর্টিস্ট।", image: "/placeholder.svg", rating: 4.7, totalReviews: 950, totalOrders: 6000, packages: [
  ...
  // --- Bridal Makeup ---
  { slug: "bridal-makeup", title: "ব্রাইডাল মেকআপ", titleEn: "Bridal Makeup", description: "বিয়ের দিনের জন্য প্রফেশনাল ব্রাইডাল মেকআপ, হেয়ার স্টাইলিং ও শাড়ি ড্রেপিং।", image: "/placeholder.svg", rating: 4.8, totalReviews: 1100, totalOrders: 7000, packages: [
  ...
  // --- Locksmith ---
  { slug: "locksmith", title: "তালা ও চাবি সার্ভিস", titleEn: "Locksmith Service", description: "দরজা, গাড়ি ও সেফের তালা খোলা, মেরামত ও ডুপ্লিকেট চাবি তৈরি।", image: "/placeholder.svg", rating: 4.5, totalReviews: 600, totalOrders: 4500, packages: [
  ...
  ], reviews: [{ name: "মো: কামরুল হাসান", rating: 5, date: "১২ মার্চ ২০২৬", comment: "রাত ১২টায় তালা আটকে গিয়েছিল, ২০ মিনিটে এসে খুলে দিয়েছে।" }], features: ["২৪/৭ ইমার্জেন্সি", "দ্রুত সেবা", "সকল ধরনের তালা", "গ্যারান্টি সহ"], availableCities: ["ঢাকা", "গাজীপুর", "নারায়ণগঞ্জ", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "সিলেট", "কুমিল্লা", "রংপুর", "ময়মনসিংহ"] },

  // --- Gym & Fitness ---
  { slug: "gym-fitness", title: "জিম ও ফিটনেস", titleEn: "Gym & Fitness", description: "পার্সোনাল ট্রেনিং, হোম জিম সেটআপ এবং ফিটনেস কনসালটেশন।", image: "/placeholder.svg", rating: 4.6, totalReviews: 700, totalOrders: 4000, packages: [
