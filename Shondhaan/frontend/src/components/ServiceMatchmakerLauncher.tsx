  ...
  return (
    <>
      <motion.button
        ...
        className="fixed right-3 z-30 hidden md:inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-primary to-green-500 px-3 py-2 text-[11px] font-semibold text-primary-foreground shadow-xl md:!bottom-[296px] md:right-4 md:text-xs"
