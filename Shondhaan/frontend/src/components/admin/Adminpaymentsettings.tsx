    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
        ...
        <div className="rounded-2xl border border-border bg-card p-4">
          <h4 className="mb-3 border-b border-border pb-3 text-base font-bold text-primary">
            পেমেন্ট মেথড
          </h4>
            ...
            <div className="space-y-3">
                    ...
                    <div key={field.key} className={isFullWidth ? "sm:col-span-2" : ""}>
                      ...
                      {field.multiline ? (
                        <textarea
                          ...
                          rows={3}
                          className="w-full rounded-lg border border-input bg-background px-3 py-2.5 text-xs font-mono text-foreground outline-none focus:border-primary"
                        />
                      ) : (
                        <div className="relative">
                          <input
                            ...
                            autoComplete="off"
                            className="w-full rounded-lg border border-input bg-background px-3 py-2.5 text-sm text-foreground outline-none focus:border-primary pr-8"
                          />
                          {field.secret && (
                            <button
                              type="button"
              ...
              <div className="flex items-center gap-3 pt-1">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-xs font-medium text-primary-foreground hover:opacity-90 disabled:opacity-50"
                >
