...
export const ROLES: RoleConfig[] = [
  ...
  { key: "mart_vendor", labelBn: "মার্ট ভেন্ডর", labelEn: "Mart Vendor", descriptionBn: "সন্ধান মার্টে নিজস্ব পণ্য বিক্রয়।", panelPath: "/mart/admin", icon: Store, gradient: "from-emerald-500 to-teal-600", accent: "text-emerald-700" },
