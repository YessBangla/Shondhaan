...
export const ROLES: RoleConfig[] = [
  ...
  { key: "admin", labelBn: "অ্যাডমিন", labelEn: "Admin", descriptionBn: "সার্ভিস, অর্ডার, ইউজার ও কনটেন্ট ম্যানেজমেন্ট।", panelPath: "/admin", icon: Shield, gradient: "from-red-500 to-rose-600", accent: "text-red-700" },
