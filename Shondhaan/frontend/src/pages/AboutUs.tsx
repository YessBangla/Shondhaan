...
const values = [
  ...
  { icon: Clock, title_bn: "সময়ানুবর্তিতা", title_en: "Punctuality", desc_bn: "নির্ধারিত সময়ে সেবা প্রদান আমাদের প্রতিশ্রুতি।", desc_en: "Delivering service on time is our commitment." },
  { icon: Award, title_bn: "মানসম্মত সেবা", title_en: "Quality Service", desc_bn: "শিল্প-মানের টুলস ও প্রশিক্ষিত পেশাদারদের মাধ্যমে সেবা।", desc_en: "Service through industry-standard tools and trained professionals." },
];
      ...
      <div className="mx-auto max-w-3xl px-4 md:px-6 py-8 md:py-14">
        ...
        <div className="mt-10 rounded-2xl border border-border bg-card p-6 md:p-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
            {bn
              ? "প্রযুক্তির মাধ্যমে ঘরোয়া সেবাকে সহজ, নিরাপদ ও স্বচ্ছ করা। আমরা চাই প্রতিটি গ্রাহক তাদের ঘরে বসে একটি ক্লিকেই দক্ষ, প্রশিক্ষিত ও বিশ্বস্ত সার্ভিসম্যানের সেবা পান।"
